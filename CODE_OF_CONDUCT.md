...
This project adopts the [Contributor Covenant](https://www.contributor-covenant.org), version 2.0. The full text is reproduced below so that anyone with a copy of this repository also has a copy of the code of conduct that applies to it.
...
Report a concern privately to the maintainer: Elio Severo Junior, [elioseverojunior@gmail.com](mailto:elioseverojunior@gmail.com) or [elio@elio.eti.br](mailto:elio@elio.eti.br).

This project is small enough that the maintainer is also the person who enforces this policy. If your concern is about the maintainer, raise it publicly in an issue or take it to a venue outside this repository -- there is no neutral third party here, and pretending otherwise would be worse than saying so.
...
The maintainer is responsible for clarifying and enforcing our standards of acceptable behavior and will take appropriate and fair corrective action in response to any behavior that they deem inappropriate, threatening, offensive, or harmful.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainer at <elioseverojunior@gmail.com>. All complaints will be reviewed and investigated promptly and fairly.
